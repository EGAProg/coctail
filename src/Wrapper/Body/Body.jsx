            ...
            <div className={styles.bodyInner}>
                <div className={styles.holder}>
                    <div className={styles.holderShirt}>
                        <img src={"./images/shirt.png"} className={styles.shirt}></img>
                    </div>
                ...
                <div className={styles.holderJEans}>
                    <img src={"./images/jeans.png"} className={styles.jeans}></img>
                </div>
            </div>
            <div className={styles.catalog}>
                <p className={styles.catalogPar}>Каталог</p>
                <img src={"/icons/catalog.svg"} className={styles.cat}></img>
            </div>
            <HalfCircle />
